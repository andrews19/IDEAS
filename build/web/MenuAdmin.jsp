<%-- 
    Document   : MenuAdmin
    Created on : 14-ene-2016, 10:43:22
    Author     : ACAMPOS
--%>
...
<head>
	...
	<meta name="author" content="El mono">
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="MenuAdmin.jsp"> <img src="img/logo_header_gonet.png" alt="logo" height="142" width="142"></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="ConsultaUsuServlet"><i class="icon-edit"></i><span class="hidden-tablet"> Editar Usuarios</span></a></li>
